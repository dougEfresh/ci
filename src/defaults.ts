...
export const DEFAULT_AI: AiJob = {
  ...
  claude_args: '',
  // '--allowedTools "mcp__github_inline_comment__create_inline_comment,Bash(command:codecov *),Bash(command:tsc *),Bash(command:tsgo *),Bash(command:bun *),Bash(command:find *),Bash(command:diff *),Bash(command:jq *),Bash(command:git *),Bash(command:cargo *),Bash(command:gh *)"',
